...
<div class="bg-white rounded-lg shadow-md p-8 max-w-md text-center">
  ...
  <!-- Título y mensaje -->
  <h2 class="text-2xl font-semibold text-gray-800 mb-2">¡Contraseña actualizada correctamente!</h2>
  <p class="text-gray-600 mb-6">Tu contraseña fue actualizada correctamente.</p>
